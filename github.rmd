...
```{r}
id2 <- "GSE24080" # this is the new dataset that i'll perform value and survival analysis for CDC7 and PCNA. 
gse2 <-getGEO(id2)
length(gse2)
gse2 <- gse2[[1]]
gse2
...
X <- t(exprs(gse)[rownames(topTable1), rownames(design)])
Y <- as.factor(pData(gse)[rownames(design), "riskinfo"])
